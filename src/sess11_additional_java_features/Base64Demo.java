...
public class Base64Demo
{
    ...
    /**
     * Encodes a string to Base64 using URL-safe encoding (RFC 4648 5( RFC- is an acronym for Request for comments- this is when you request for certain features to be added to the next version of Java or any other language)).
     * Uses '-' instead of '+', '-' instead of '/' & omits padding '='.
     * 
     * @param input The input string to be encoded.
